...
class Trainer(BaseTrainer):
    ...
    def __init__(self, model, criterion, metric_ftns, optimizer, config, data_loader,
        ...
        self.config = config
        # summary(self.model, input_size=(128,3,32,32), batch_size=128,device="cuda") # CIFAR-100-LT
        # summary(self.model, input_size=(64, 3, 224, 224), batch_size=128,device="cuda") # ImageNet-LT
        # summary(self.model, input_size=(128, 3, 224, 224), batch_size=128,device="cuda") # Places-LT
